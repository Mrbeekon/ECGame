...
public:
    ...
    int next(uint max);              // Returns the next random integer, with a specified maximum
    int next(uint min, uint max);     // Returns the next random integer, with a specified range
